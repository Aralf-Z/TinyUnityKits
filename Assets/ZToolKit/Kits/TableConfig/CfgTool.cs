...
namespace ZToolKit
{
    public static class CfgTool
    {
        ...
        private static readonly string rFoldPath = Path.Combine(Application.streamingAssetsPath, "ZTool/Luban/TableConfig");
        
        private static bool sInited;

        public static readonly string fileListPath = Path.Combine(Application.streamingAssetsPath, "ZTool/Luban/cfgFileList.json"); 
