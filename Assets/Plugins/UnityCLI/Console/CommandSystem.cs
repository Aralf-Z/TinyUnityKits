   ...
   public interface ICommandCreator
    {
        ...
        IEnumerable<StackProperty> CollectProperties<T>() where T: CommandPropertyAttribute{
        ...
        IEnumerable<(ValueParser, Type, string)> CollectValueParsers<T>() where T : CommandValueParserAttribute{
    ...
    public partial class CommandSystem
    {
        readonly ICommandCreator commandCreator;
