...
namespace RedSaw.CommandLineInterface{
    ...
    public interface ICommandCreator
    {
        ...
        IEnumerable<Command> CollectCommands<T>() where T : CommandAttribute;

        /// <summary>get all parameter parser function from given types</summary>
        void RegisterParameterParsers(Type[] totalTypes);

        /// <summary>check if target methodInfo have same signature with given delegate type</summary>
        bool TryConvertDelegate<T>(MethodInfo methodInfo, out T result) where T : Delegate;
        ...
        /// <returns>return true if success</returns>
        bool CreateCommand(MethodInfo methodInfo, CommandAttribute attr, out Command command);
    }
    
    /// <summary>default command creator</summary>
    public class DefaultCommandCreator: ICommandCreator
    {
        public IEnumerable<Command> CollectCommands<T>() where T: CommandAttribute{
        ...
        public void RegisterParameterParsers(Type[] totalTypes){
        ...
        public bool TryConvertDelegate<T>(MethodInfo methodInfo, out T result) where T: Delegate
        {
        ...
        public bool CreateCommand(MethodInfo methodInfo, CommandAttribute attr, out Command command){
    ...
    public static class CommandSystem{
        ...
        static class DefaultCommandDef{
            ...
            static void Logo(){
                ...
                */
                Output("Powered by RedSawStudio.");
            }
        ...
        static ICommandCreator commandCreator;
        ...
        {
            commandCreator = new DefaultCommandCreator();
